 // ---------- PRODUCT DATABASE ----------
    const products = [
        { id: 1, name: "sweater", brand: "Fendi", price: 40, originalPrice: 60, discount: "26%", image: "productImages/vintage.jpg" },
        { id: 2, name: "Vintage Denim Jacket", brand: "Levi's", price: 55, originalPrice: 85, discount: "35%", image: "productImages/Denim.webp" },
        { id: 3, name: "Floral Summer Dress", brand: "Zara Thrift", price: 32, originalPrice: 50, discount: "36%", image: "productImages/Floral.avif" },
        { id: 4, name: "Retro Sneakers", brand: "Nike Vintage", price: 70, originalPrice: 110, discount: "36%", image: "productImages/RetroSneakers.jpg" },
        { id: 4, name: "Retro Sneakers", brand: "Nike Vintage", price: 70, originalPrice: 110, discount: "36%", image: "productImages/RetroSneakers.jpg" }
    ];
